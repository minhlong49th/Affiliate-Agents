...
(Note: Bing Ads CSV will be automatically generated by the orchestrator via a find-replace script from the Google CSV. You do not need to generate it.)

After writing, return to orchestrator (`ppc-affiliate-pipeline`) to proceed to Step 9.
